...
\newcommand{\tablecaption}[2]{\par\noindent\makebox[\textwidth][c]{\footnotesize\textbf{Table #1.} #2}\par\vspace{-7pt}}
\newcommand{\figurecaption}[2]{\par\noindent\makebox[\textwidth][c]{\footnotesize\textbf{Figure #1.} #2}\par\vspace{-7pt}}
...
\end{center}
\figurecaption{1}{SumR across segment/frame fusion weights.}
\vspace{10pt}
