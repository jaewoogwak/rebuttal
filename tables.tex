...
\newcommand{\figurecaption}[2]{\begin{center}\footnotesize\textbf{Figure #1.} #2\end{center}\vspace{-7pt}}
...
\tablecaption{1}{Base configurations and boundary statistics.}
\begin{center}
\small
...
\tablecaption{2}{Shared boundary hyperparameters for U1 and U2.}
\begin{center}
\small
\begin{tabular}{l c c}
\toprule
...
\tablecaption{3}{Retrieval performance under the base, U1, and U2 boundary configurations.}
\begin{center}
\small
...
\section*{3. Intra-Query Segment Separation and Qvhighlights Length Regularization}
\tablecaption{4}{Intra-query segment separation and Qvhighlights length regularization.}
\begin{center}
\small
...
\tablecaption{5}{Segment/frame fusion sensitivity.}
\begin{center}
\small
...
\end{center}
\figurecaption{1}{Segment/frame fusion sensitivity.}
\section*{5. Boundary Construction Time}
\tablecaption{6}{Boundary construction time.}
\begin{center}
\small
\begin{tabular}{l r}
\toprule
